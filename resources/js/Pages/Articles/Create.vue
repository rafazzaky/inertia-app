            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-6 py-3">
                    ...
                    <div class="mb-6">
                        ...
                        <select v-model="form.topic_id" id="topic_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea v-model="form.content" name="content" id="content" cols="30" rows="10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="some content..." required></textarea>
                    </div>
                    <button type="submit" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg border border-gray-300">Create</button>
                    </form>
